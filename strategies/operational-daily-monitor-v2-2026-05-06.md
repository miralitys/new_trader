...
Generated: 2026-05-06T15:01:28.450483+00:00

| Status | Symbol | Group | Strategy | 30d | PF30 | DD30 | Stress taker 30d | Paper 7d | Paper PF | Reason |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| TRADE | SPELLUSDT | best_strategy | SPELL SHORT Best | +5.20% | 1.84 | 6.09% | +4.12% | n/a | n/a | return +5.20% > 0.00%; PF 1.84 >= 1.08; DD 6.09% <= 16.00%; trades 16 >= 10 | stress passed |
| TRADE | RIFUSDT | regime_monitor | RIF Regime Monitor | +30.54% | 1.95 | 6.00% | +7.50% | n/a | n/a | 30d+60d health | stress passed |
...
| WATCH | GALAUSDT | best_strategy | Минутка 7.3 | +29.77% | 1.67 | 3.50% | +4.01% | -0.06% | 0.98 | return +29.77% > 0.00%; PF 1.67 >= 1.05; DD 3.50% <= 18.00%; trades 1257 >= 30 | stress passed | paper weak: paper return -0.06% <= 0.00%; paper PF 0.98 < 1.00 |
...
| WATCH | GALAUSDT | best_strategy | Минутка 11.2 | +33.03% | 1.59 | 4.93% | -0.30% | n/a | n/a | return +33.03% > 0.00%; PF 1.59 >= 1.08; DD 4.93% <= 18.00%; trades 1327 >= 30 | stress failed: taker_like: return -0.30% <= 0; PF 0.99 < 1.00 |
...
| WATCH | GALAUSDT+SPELLUSDT | cashflow | Monthly Cashflow 4% 24M | n/a | n/a | n/a% | n/a | n/a | n/a | constituent strategies are mixed: ['WATCH', 'TRADE'] |
...
| OFF | ANKRUSDT | best_strategy | ANKR LONG Best | -1.34% | 0.58 | 2.19% | -1.69% | n/a | n/a | return -1.34% <= 0.00%; PF 0.58 < 1.08; trades 5 < 10 |
