...
Generated: 2026-05-05T15:19:40.794651+00:00

| Status | Symbol | Group | Strategy | 30d | PF30 | DD30 | Stress taker 30d | Paper 7d | Paper PF | Reason |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---|
| TRADE | RIFUSDT | regime_monitor | RIF Regime Monitor | +30.51% | 2.15 | 6.00% | +6.60% | n/a | n/a | 30d+60d health | stress passed |
| WATCH | CHZUSDT | best_strategy | Минутка 10 CHZ Best | +8.15% | 4.64 | 1.14% | +5.95% | n/a | n/a | return +8.15% > 0.00%; PF 4.64 >= 1.05; DD 1.14% <= 15.00%; trades 26 >= 10 | stress passed |
| WATCH | GALAUSDT | best_strategy | Минутка 7.3 | +29.73% | 1.64 | 3.50% | +3.37% | -0.06% | 0.98 | return +29.73% > 0.00%; PF 1.64 >= 1.05; DD 3.50% <= 18.00%; trades 1291 >= 30 | stress passed | paper weak: paper return -0.06% <= 0.00%; paper PF 0.98 < 1.00 |
| WATCH | GALAUSDT | best_strategy | Минутка 10 | +17.58% | 1.75 | 1.41% | +6.18% | n/a | n/a | return +17.58% > 0.00%; PF 1.75 >= 1.05; DD 1.41% <= 18.00%; trades 1118 >= 20 | stress failed: strict_maker: return -0.82% <= 0; PF 0.96 < 1.00 |
| WATCH | GALAUSDT | best_strategy | Минутка 11.2 | +32.61% | 1.56 | 4.93% | -0.12% | n/a | n/a | return +32.61% > 0.00%; PF 1.56 >= 1.08; DD 4.93% <= 18.00%; trades 1359 >= 30 | stress failed: taker_like: return -0.12% <= 0; PF 1.00 < 1.00 |
...
| WATCH | ONEUSDT | best_strategy | Минутка 11.2 | +10.35% | 1.26 | 3.62% | +4.49% | n/a | n/a | return +10.35% > 0.00%; PF 1.26 >= 1.05; DD 3.62% <= 18.00%; trades 858 >= 20 | stress weak: strict_maker: return -11.12% <= 0; PF 0.62 < 1.00 |
| WATCH | SPELLUSDT | best_strategy | SPELL SHORT Best | +2.82% | 1.34 | 6.99% | +1.68% | n/a | n/a | return +2.82% > 0.00%; PF 1.34 >= 1.08; DD 6.99% <= 16.00%; trades 17 >= 10 | stress failed: strict_maker: return -0.78% <= 0; PF 0.90 < 1.00 |
...
| WATCH | ACHUSDT | regime_monitor | ACH Regime Monitor | +16.99% | 1.89 | 4.31% | +4.46% | n/a | n/a | 30d+60d health | stress passed |
| WATCH | REZUSDT | regime_monitor | REZ Regime Monitor | +29.39% | 1.56 | 8.38% | +25.51% | n/a | n/a | 30d+60d health | stress passed |
...
| OFF | ANKRUSDT | best_strategy | ANKR LONG Best | -2.21% | 0.46 | 3.05% | -2.64% | n/a | n/a | return -2.21% <= 0.00%; PF 0.46 < 1.08; trades 6 < 10 |
